...
def main():
    ...
    # START - accounts are initialized, authenticated

    # Get historical data
    hist_spx = api.priceHistory.bySymbol("SPX", periodType='month', period=6, frequencyType='daily', frequency=1, startDate=None,
                        endDate=None, needExtendedHoursData=False, needPreviousClose=True).json()

    

    # Crunch the numbers and compute p(C|O)
